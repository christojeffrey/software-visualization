 ...
 */
export function rectangleCollideForce(): Force<
	simulationNodeDatumType,
	d3.SimulationLinkDatum<simulationNodeDatumType>
> {
...
export function radialClampForce(
	r: () => number
): Force<simulationNodeDatumType, d3.SimulationLinkDatum<simulationNodeDatumType>> {
	let nodes: simulationNodeDatumType[];
