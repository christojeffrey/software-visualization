...
<div>
    ...
    <div>
        ...
        to collapse node, click the green button. Tolerance: <input type='input' style='width: 2em; border: 1px solid black; margin: 0 0 10px 4px;' 
        bind:value={dependencyLiftTolarance} on:keyup={(d) => {
